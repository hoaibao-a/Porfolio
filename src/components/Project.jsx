...
const Single = ({ index, name, description, image, projectId }) => {
  ...
  return (
    <section className="project-section text-black max-w-7xl mx-auto">
      <div className="project-container">
        <div className="project-wrapper">
          ...
          <motion.div className="project-textContainer" style={{ y }}>
            <h2 className="font-bold text-black text-[40px] hover:text-light-orange">{name}</h2>
            <p className="font-medium text-[#100D25] opacity-70">{description}</p>
            <button
              className="bg-light-orange cursor-pointer py-3 px-8 rounded-xl w-fit text-white font-bold hover:text-[#151030]"
    ...
    <div className="project" ref={ref}>
      <div className={`${styles.sectionHeadText} text-center progress`}>
        ...
        >
          ...
          <motion.div style={{ scaleX }} className="mt-2 progressBar"></motion.div>
        </motion.div>
      </div>
