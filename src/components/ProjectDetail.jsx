...
const ProjectDetail = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      <h1 className="text-4xl font-bold text-light-orange mt-8">{project.name}</h1>
      <p className="text-gray-700 text-lg mt-4 italic">{project.participants}</p>
      ...
      <div className="mt-12">
        ...
        <p className="text-lg mt-4 text-gray-700">{project.description}</p>
      </div>
      ...
      <div className="mt-6 flex justify-between">
        ...
        {project.source && (
          <a
            ...
            className="bg-light-orange text-white px-6 py-3 rounded-lg font-semibold hover:bg-orange-600 transition-all"
          >
